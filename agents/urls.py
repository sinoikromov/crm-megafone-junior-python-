...
from .views import (
    ListAgentView, CreateAgentView, DetailAgentView, UpdateAgentView,
    AgentDeleteView, SearchResultsListView
)
...
urlpatterns = [
    ...
    path('search/', SearchResultsListView.as_view(), name='search_agent'),
